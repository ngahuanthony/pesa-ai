...
router.get("/api/setup", setupRoutes.get);
router.post("/api/setup", setupRoutes.start);
router.patch("/api/setup", setupRoutes.update);
router.post("/api/setup/products", setupRoutes.addProduct);
router.patch("/api/setup/products/:id", setupRoutes.changeProduct);
router.delete("/api/setup/products/:id", setupRoutes.removeProduct);
