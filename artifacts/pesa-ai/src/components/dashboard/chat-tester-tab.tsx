...
export function ChatTesterTab() {
  ...
  return (
    <div className="space-y-4">
      {/* Header */}
      <div>
        <h2 className="text-xl font-bold text-foreground">Chat Tester</h2>
        <p className="text-sm text-muted-foreground">Test how your assistant responds before customers message you.</p>
      </div>

      <div className="grid md:grid-cols-[280px_1fr] gap-4" style={{ height: "580px" }}>
        {/* Left panel */}
        <div className="flex flex-col gap-5 border border-border rounded-xl p-5 bg-card overflow-auto">
          {/* Persona card */}
