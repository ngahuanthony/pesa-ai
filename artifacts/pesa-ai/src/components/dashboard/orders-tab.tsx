...
import { ShoppingBag, Smartphone, ChevronDown } from "lucide-react";
  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-sm text-muted-foreground">Customer orders placed through your WhatsApp shop.</p>
      </div>
                    ...
                    <DialogContent>
                      ...
                      <form onSubmit={handleMpesaPay} className="space-y-4 mt-4">
                        <div className="p-4 bg-muted rounded-xl text-sm">
                          Amount to collect: <strong className="text-foreground">KES {o.totalKES.toLocaleString()}</strong>
                        </div>
