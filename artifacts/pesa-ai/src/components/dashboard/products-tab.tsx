                         ...
                         {p.colorStock && p.colorStock.length > 0 && (
                           <div className="mt-1 flex flex-wrap gap-1">
                             {p.colorStock.map((entry) => (
                               <span key={entry.color.toLowerCase()} className="rounded bg-muted px-1.5 py-0.5 text-[10px] font-medium text-muted-foreground">
                                 {entry.color}: {entry.quantity}
                               </span>
                             ))}
                           </div>
                         )}
                          ...
                          <div className="flex items-center gap-2 mt-2 flex-wrap">
                           ...
                           {p.colorStock && p.colorStock.length > 0 && (
                             <div className="mt-2 flex flex-wrap gap-1.5">
                               {p.colorStock.map((entry) => (
                                 <span key={entry.color.toLowerCase()} className="rounded-full bg-muted px-2 py-1 text-[11px] font-medium text-muted-foreground">
